...
ActiveRecord::Schema[7.0].define(version: 2023_07_22_121422) do
  ...
  create_table "baby_products", force: :cascade do |t|
    ...
    t.string "productHightlights", default: [], array: true
  ...
  create_table "cart_items", force: :cascade do |t|
    ...
    t.index ["phone_id"], name: "index_cart_items_on_phone_id"
  end
  ...
  add_foreign_key "cart_items", "baby_products"
  add_foreign_key "cart_items", "carts"
  add_foreign_key "cart_items", "phones"
